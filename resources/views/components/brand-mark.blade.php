...
<svg class="{{ $class ?? 'h-8 w-8' }}" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <path d="M256 124 L256 200" stroke="#0b1118" stroke-opacity="0.55" stroke-width="5" stroke-linecap="round"/>

    {{-- Exposure / badge dot --}}
    <circle cx="348" cy="188" r="16" fill="#0b1118"/>
    <circle cx="348" cy="188" r="8" fill="#7df4ba"/>
</svg>
